...
HF_TOKEN="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"
...
def main():
    ...
    config = LlamaConfig.from_pretrained(args.model_path, device_map=device_map, load_in_8bit=True, token=HF_TOKEN)
    ...
    # ==============================
    tokenizer = LlamaTokenizer.from_pretrained("hf-internal-testing/llama-tokenizer", token=HF_TOKEN)
    ...
    dataset = dataframe_2_datasets(train, test)
